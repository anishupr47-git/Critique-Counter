...
from .serializers import EssaySerializer, EssayCategorySerializer
...
class EssayViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if author is not None:
            queryset = queryset.filter(author_tag__iexact=author)
        ...
        for essay in reversed(essays):
            if hasattr(essay, 'metrics'):
                timeline.append({
                    ...
                    'passive_voice_percentage': essay.metrics.passive_voice_percentage,
